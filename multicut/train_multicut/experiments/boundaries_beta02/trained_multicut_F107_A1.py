...
def main():
    ...
    seg = multicut_segmentation(raw.astype(np.float32), hmap, rf, False, watershed=ws, mask=mask, n_threads=2, beta=0.2)
    print(seg.shape)
    
    write_volume(train_multicut_path, seg, "segmentation/rf_multicut_beta02")
