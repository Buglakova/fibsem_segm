...
def get_data_paths():
    ...
    n5_paths.sort()
    train_data_paths = n5_paths[:1]
    print("Train datasets: ", len(train_data_paths))
    val_data_paths = n5_paths[1:]
    print("Validation datasets: ", val_data_paths)
    data_key = "3dunet/raw"
    label_key = "3dunet/labels_masked"
...
if __name__ == "__main__":
    ...
    data_key = "raw"
    label_key = "F107_A1_em.n5/segmentation/ground_truth_channels"

    experiment_name = "full_masked_dice_platy_masked"
    train_data_paths, val_data_paths, data_key, label_key = get_data_paths()
    train_rois = [np.s_[33:97, :, :]]
    val_rois = [np.s_[33:97, :, :]]
