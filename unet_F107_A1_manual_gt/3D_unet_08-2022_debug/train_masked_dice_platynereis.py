...
def check_data(data_paths, data_key, label_paths, label_key, rois):
    ...
    try:
        ds = torch_em.default_segmentation_dataset(data_paths, data_key, label_paths, label_key, patch_shape, with_label_channels=True, is_seg_dataset=True)
...
if __name__ == "__main__":
    ...
    experiment_name = "full_masked_dice_platy"
