...
def main():
    ...
    raw = read_volume("/scratch/buglakova/data/cryofib/segm_fibsem/F107/F107_A1_train_network.n5", "input/raw")
    ...
    print(f_pred)
    model_path = "modelzoo/full_dice_noaugment_nomask/full_dice_noaugment_nomask.zip"
