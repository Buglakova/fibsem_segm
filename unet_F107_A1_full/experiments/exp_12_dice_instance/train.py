...
if __name__ == "__main__":
    ...
    experiment_name = "exp_12_dice_instance"
    ...
    model.encoder.blocks[0].block[0] = nn.InstanceNorm3d(first_instance_norm.num_features, track_running_stats = "True")
    print(model)

    ckpt = torch.load("/g/kreshuk/buglakova/projects/fibsem_segm/unet_F107_A1_full/experiments/exp_12_dice_instance/checkpoints/exp_12_dice_instance/best.pt")
