...
def main():
    ...
    print(f_pred)
    model_path = "/g/kreshuk/buglakova/projects/fibsem_segm/unet_F107_A1_full/experiments/exp_10_dice_F056_A1/modelzoo/exp_10_dice_F056_A1/exp_10_dice_F056_A1.zip"
    prefix = "F056_A1_boundary_predictions/dice_16x512x512"
