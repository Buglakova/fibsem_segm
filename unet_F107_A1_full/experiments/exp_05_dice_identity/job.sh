...
#SBATCH -o /g/kreshuk/buglakova/projects/fibsem_segm/unet_F107_A1_full/experiments/exp_05_dice_identity/slurm-%j.out-%N			       # file to write the command line output to
#SBATCH -e /g/kreshuk/buglakova/projects/fibsem_segm/unet_F107_A1_full/experiments/exp_05_dice_identity/slurm-%j.err-%N			       # file to write the error output to
...
python /g/kreshuk/buglakova/projects/fibsem_segm/unet_F107_A1_full/experiments/exp_05_dice_identity/train.py