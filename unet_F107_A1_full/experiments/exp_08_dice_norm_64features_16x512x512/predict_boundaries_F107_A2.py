...
def main():
    ...
    raw = read_volume("/scratch/buglakova/data/cryofib/segm_fibsem/F107/F107_A2_em.n5", "input/raw_norm")
    print("Create prediction files")
    f_pred = "/scratch/buglakova/data/cryofib/segm_fibsem/F107/F107_A2_em_thin_boundaries_predictions.n5"
    print(f_pred)
